  ...
  executeCommand(command) {
    ...
    try {
      if (command.startsWith("cat ") || command === "cat") {
        ...
        this.showError(
          `${command} is not a valid command! Type "help" to see a list of valid commands.`
        )
      }
    } catch (e) {
      console.error(e)
    ...
    if (this.inputMode) {
      ...
      this.terminal.append(`
              <div class="terminal-line">
                  <p class="command-text">${this.userIp || "anonymous"}@terminal:<span class="terminal-path">${this.currentDirectory.getFullPathFromRoot()}/</span>&nbsp;>&nbsp;</p>
